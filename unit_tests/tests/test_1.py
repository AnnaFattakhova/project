...
# TEST 2 — проверяет ключевой бизнес-инвариант (px → рейтинг)
# TEST 3 — документирует fallback-поведение при отсутствии HTML-данных
...
# ======================================================
# TEST 3. Edge cases: отсутствие данных
# ======================================================
